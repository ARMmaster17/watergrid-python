...
class RedisPipelineLock(PipelineLock):
    def __init__(self, lock_key: str, redis_host: str, redis_port: int, redis_db: int, redis_password: str = None, lock_timeout: int = None):
        self.__redis = Redis(host=redis_host, port=redis_port, db=redis_db, password=redis_password)
